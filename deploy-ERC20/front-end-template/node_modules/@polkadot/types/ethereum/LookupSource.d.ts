...
import EthereumAccountId from '@polkadot/types/ethereum/AccountId';
declare type AnyAddress = BN | LookupSource | EthereumAccountId | AccountIndex | number[] | Uint8Array | number | string;
