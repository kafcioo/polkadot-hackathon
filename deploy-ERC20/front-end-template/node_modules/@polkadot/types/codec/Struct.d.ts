...
import { AnyJson, BareOpts, Codec, Constructor, InterfaceTypes, Registry } from '@polkadot/types/types';
 ...
 * @noInheritDoc
 */
export default class Struct<S extends TypesDef = TypesDef, V extends {
    [K in keyof S]: any;
} = {
    [K in keyof S]: any;
}, E extends {
