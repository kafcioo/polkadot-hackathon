...
import { AnyJson, Codec, Constructor, InterfaceTypes, Registry } from '@polkadot/types/types';
/**
 * @name Option
 * @description
...
export default class Option<T extends Codec> implements Codec {
    ...
    static with<O extends Codec>(Type: Constructor<O> | keyof InterfaceTypes): Constructor<Option<O>>;
    /**
