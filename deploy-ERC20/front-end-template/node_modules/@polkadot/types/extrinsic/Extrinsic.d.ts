...
import { EcdsaSignature, Ed25519Signature, ExtrinsicUnknown, ExtrinsicV4, Sr25519Signature } from '@polkadot/types/interfaces/extrinsics';
import { Address, Balance, Call, Index } from '@polkadot/types/interfaces/runtime';
import { AnyJson, AnyU8a, ArgsDef, Codec, ExtrinsicPayloadValue, IExtrinsic, IKeyringPair, Registry, SignatureOptions } from '@polkadot/types/types';
...
export { EXTRINSIC_VERSION as LATEST_EXTRINSIC_VERSION } from '@polkadot/types/extrinsic/v4/Extrinsic';
