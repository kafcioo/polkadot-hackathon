...
export * from '@polkadot/api-derive/accounts/types';
export * from '@polkadot/api-derive/council/types';
export * from '@polkadot/api-derive/democracy/types';
export * from '@polkadot/api-derive/elections/types';
export * from '@polkadot/api-derive/parachains/types';
export * from '@polkadot/api-derive/session/types';
export * from '@polkadot/api-derive/staking/types';
...
export declare type DeriveCollectiveProposals = DeriveCollectiveProposal[];
